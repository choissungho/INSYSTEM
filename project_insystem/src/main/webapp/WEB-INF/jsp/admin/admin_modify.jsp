...
$(document).ready(function() {
  ...
  $("#language_add").click(function() {
	j++;
    $("#language").append("<tr style='line-height:32px;' id='language_table"+j+"'><td>언어　</td><td><select class='form-control' id='la_"+j+"' name='la_"+j+"'><c:forEach var='option' items='${lang_op}'><option value='${option.sclasCode}'>${option.sclasCdnm}</option></c:forEach></select></td><td><select class='form-control' id='la2_"+j+"' name='la2_"+j+"''><c:forEach var='option2' items='${lang_op2}'><option value='${option2.sclasCode}'>${option2.sclasCdnm}</option></c:forEach></select></td></tr>");  
	...
	//자격증 추가 부분
 	$("#licence_add").click(function() {
		i++;
	    $("#licence").append("<tr style='line-height:32px;' id='licence_table"+i+"'><td>자격증</td><td><select class='form-control' id='li_"+i+"' name='li_"+i+"'><c:forEach var='option3' items='${licence_op}'><option value='${option3.sclasCode}'>${option3.sclasCdnm}</option></c:forEach></select></td></tr>");  
		                                ...
		                                <td>
		                                    <select class="form-control" id="li_0" name="li_0">
										      <c:forEach var="option3" items="${licence_op}">
										     	<option value="${option3.sclasCode}">${option3.sclasCdnm}</option>
										      </c:forEach>
										    </select>
		                                </td>
		                            </tr>
